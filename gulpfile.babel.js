/* -------------------------------------------------------------------------------------------------------------------------------------------
   ...
   3.   npm run p-1     -  Используется для создание продакщен версии билда со всеми флагами gulp clean watch --series --prod --minHtml --minCss --minJs --minImg.
   3.1  npm run p-2     -  Используется для создание продакщен версии билда без минификации изображения gulp clean watch --series --prod --minHtml --minCss --minJs.
